...
Future<void> main() async {
  ...
  runApp(const PilloraApp());
}

class PilloraApp extends StatelessWidget {
  const PilloraApp({super.key, this.home = const OnboardingScreen(), this.simulateDevice = kIsWeb});
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        colorScheme: ColorScheme.fromSeed(seedColor: Palette.deep),
