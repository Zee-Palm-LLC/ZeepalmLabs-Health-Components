# ZeepalmLabs Health Components

A collection of Flutter projects, each in its own folder.

## Projects

- `animated_profile` - Animated doctor profile UI with tap-to-reveal ripple effect, built with Iconsax icons.
