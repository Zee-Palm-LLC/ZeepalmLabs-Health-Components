      ...
      child: Stack(
        children: [
          Positioned(
            left: 37,
            top: 19,
            child: Text('9:41', style: jakarta(16.5, 700, color: Hue.ink, spacing: -0.2, height: 1.35)),
          ),
          Positioned(
            left: width / 2 - 62,
            top: 12,
...
class _Icons extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    final fill = Paint()..color = const Color(0xFF2A2230);
    for (var i = 0; i < 4; i++) {
      final h = 4.2 + i * 2.6;
      canvas.drawRRect(
    ...
    canvas.drawRRect(
      ...
      Paint()..color = const Color(0x662A2230),
    );
  }
